...
mongoose
  ...
  .then(async () => {
    ...
    // Apni frontend wali services yahan paste karni hain
    const services = [
      // 👇👇 YAHAN APNA POORA ARRAY PASTE KARO
...
// ================-------------------combo-----------------------------
{
  ...
  content: {
    includes:
      "Half Leg Scrubbing using premium exfoliating scrub for smooth and glowing skin.",

    about:
      "Half Leg Scrubbing removes dead skin cells, improves blood circulation, and leaves your legs soft, refreshed, and radiant.",

    benefits: [
      {
        title: "1. Deep Exfoliation",
        whatIs:
          "Removes dead skin cells and rough patches from the legs.",
        benefit:
          "Makes skin smoother, brighter, and healthier.",
        result:
          "Soft, glowing, and refreshed legs instantly.",
      },
      {
        title: "2. Skin Brightening",
        whatIs:
          "Helps reduce tanning and dullness caused by pollution and sun exposure.",
        benefit:
          "Improves skin tone and gives a natural glow.",
        result:
          "Brighter and more even-looking skin.",
      },
      {
        title: "3. Moisturizing Finish",
        whatIs:
          "A nourishing moisturizer is applied after scrubbing.",
        benefit:
          "Locks in hydration and prevents dryness.",
        result:
          "Silky smooth legs with long-lasting softness.",
      },
    ],

    whyBook: [
      "Professional salon service at home.",
